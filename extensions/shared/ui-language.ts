...
const TRANSLATIONS: Record<string, Partial<Record<UiLanguage, string>>> = {
	...
	"› /doctor 检查本地工具": { "ja-JP": "› /doctor ローカルツール確認", "ko-KR": "› /doctor 로컬 도구 확인", "fr-FR": "› /doctor Vérifier les outils locaux", "de-DE": "› /doctor Lokale Tools prüfen", "es-ES": "› /doctor Revisar herramientas locales", "pt-BR": "› /doctor Verificar ferramentas locais", "ru-RU": "› /doctor Проверить локальные инструменты" },
