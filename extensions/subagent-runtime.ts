...
const DEFAULT_PER_TASK_OUTPUT_CAP = 50 * 1024;
...
export interface SingleResult {
	agent: string;
	agentSource: "install" | "user" | "project" | "unknown";
	task: string;
	exitCode: number;
	messages: Message[];
	stderr: string;
...
export function getResultOutput(result: Pick<SingleResult, "exitCode" | "stopReason" | "errorMessage" | "stderr" | "messages">): string {
...
export function truncateParallelOutput(output: string, cap = DEFAULT_PER_TASK_OUTPUT_CAP): string {
