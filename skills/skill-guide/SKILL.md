...
1. **System skills** — `<ugk>/skills/` (ugk-guide, mcp-guide, bash-guide, chrome-cdp-guide, skill-creator, task-install-guide, skill-guide, ...). Ship with ugk. **Read-only** — a ugk update overwrites them.
